...
export enum I18nKey {
  ...
  PROJECT_MANAGEMENT$INTEGRATIONS_TITLE = "PROJECT_MANAGEMENT$INTEGRATIONS_TITLE",
  ...
  PROJECT_MANAGEMENT$INFO_MODAL_TITLE = "PROJECT_MANAGEMENT$INFO_MODAL_TITLE",
  PROJECT_MANAGEMENT$INFO_MODAL_DESCRIPTION = "PROJECT_MANAGEMENT$INFO_MODAL_DESCRIPTION",
  PROJECT_MANAGEMENT$CLOSE_BUTTON_LABEL = "PROJECT_MANAGEMENT$CLOSE_BUTTON_LABEL",
  PROJECT_MANAGEMENT$UNLINK_CONFIRMATION_TITLE = "PROJECT_MANAGEMENT$UNLINK_CONFIRMATION_TITLE",
  PROJECT_MANAGEMENT$LINK_CONFIRMATION_TITLE = "PROJECT_MANAGEMENT$LINK_CONFIRMATION_TITLE",
  PROJECT_MANAGEMENT$UNLINK_CONFIRMATION_DESCRIPTION = "PROJECT_MANAGEMENT$UNLINK_CONFIRMATION_DESCRIPTION",
  PROJECT_MANAGEMENT$LINK_CONFIRMATION_DESCRIPTION = "PROJECT_MANAGEMENT$LINK_CONFIRMATION_DESCRIPTION",
  PROJECT_MANAGEMENT$CONFIRM_BUTTON_LABEL = "PROJECT_MANAGEMENT$CONFIRM_BUTTON_LABEL",
}
