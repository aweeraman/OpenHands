...
export enum I18nKey {
  ...
  BUTTON$LINK_INTEGRATION = "BUTTON$LINK_INTEGRATION",
  BUTTON$UNLINK_INTEGRATION = "BUTTON$UNLINK_INTEGRATION",
  BUTTON$ALLOW_INTEGRATION = "BUTTON$ALLOW_INTEGRATION",
  BUTTON$CANCEL_INTEGRATION = "BUTTON$CANCEL_INTEGRATION",
  INTEGRATIONS$PROJECT_MANAGEMENT = "INTEGRATIONS$PROJECT_MANAGEMENT",
  INTEGRATION$SPLENDID_TITLE = "INTEGRATION$SPLENDID_TITLE",
  INTEGRATION$ALREADY_INTEGRATED_MESSAGE = "INTEGRATION$ALREADY_INTEGRATED_MESSAGE",
  INTEGRATION$PERMISSION_PROMPT = "INTEGRATION$PERMISSION_PROMPT",
  INTEGRATION$JIRA_CLOUD = "INTEGRATION$JIRA_CLOUD",
  INTEGRATION$JIRA_DATA_CENTER = "INTEGRATION$JIRA_DATA_CENTER",
